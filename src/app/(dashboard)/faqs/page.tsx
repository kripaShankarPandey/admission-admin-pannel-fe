...
import { faqService, type Faq, type FaqPayload } from "@/services/faq-service";
import {
  Table,
  TableBody,
  TableCell,
          ...
          <TableBody>
            {isLoading ? (
              ...
              filtered.map((item) => (
                ...
                >
                  <TableCell className="font-semibold text-foreground text-[13px] max-w-xs">
                    {item.question}
                  </TableCell>
              ...
              <TableStateRow
                colSpan={4}
                emptyLabel="No FAQs yet. Add one to get started."
              />
            )}
          </TableBody>
        </Table>
